...
from app.tools.financial_tools import PortfolioAnalyzer, StockDataFetcher
...
class TestPortfolioAnalyzer:
    ...
    def test_analyze_portfolio(self, mock_technical, mock_info):
        ...
        mock_technical.return_value = {"trend": "uptrend", "momentum": "bullish"}

        holdings = [{"symbol": "AAPL", "quantity": 10, "purchase_price": 140.0}]
