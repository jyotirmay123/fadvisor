...
class NewsAnalyzer:
            ...
            return [
                {
                    ...
                    "datetime": datetime.fromtimestamp(item.get("providerPublishTime", 0)),
                    "sentiment": self._analyze_basic_sentiment(
                        item.get("title", "") + " " + item.get("summary", item.get("title", ""))
                    )
                }
                for item in news[:10]
            ]
    ...
    def _analyze_basic_sentiment(self, text: str) -> Dict[str, Any]:
        ...
        # Positive keywords
        positive_keywords = [
            "surge", "rally", "gain", "profit", "revenue", "beat", "upgrade",
            "positive", "growth", "expand", "increase", "breakthrough", "success",
            "outperform", "bullish", "optimistic", "strong", "record"
        ]
        
        # Negative keywords
        negative_keywords = [
            "loss", "decline", "fall", "drop", "miss", "downgrade", "negative",
            "concern", "risk", "weak", "bearish", "pessimistic", "warning",
            "lawsuit", "investigation", "recall", "bankruptcy", "layoff"
        ]
    ...
    def summarize_news_sentiment(self, news_items: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _extract_key_topics(self, text: str) -> List[str]:
        ...
        stop_words = {
            ...
            "should", "may", "might", "must", "can", "stock", "stocks", "market"
        }
