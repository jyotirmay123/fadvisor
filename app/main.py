...
from app.utils import OpenRouterLLM, FREE_MODELS
...
class FAdvisorCLI:
    ...
    def setup(self, model: Optional[str] = None):
        ...
        try:
            ...
            if not llm.test_connection():
                logger.error("Failed to connect to OpenRouter. Please check your API key.")
                return False
